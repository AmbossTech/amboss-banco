...
// export const testNostr = () => {
//   // Test case using the above example
//   const senderPrivateKey = nip19.decode(
//     `nsec1p0ht6p3wepe47sjrgesyn4m50m6avk2waqudu9rl324cg2c4ufesyp6rdg`
//   ).data;

//   console.log({ senderPrivateKey: bufToHex(senderPrivateKey) });

//   const recipientPrivateKey = nip19.decode(
//     `nsec1uyyrnx7cgfp40fcskcr2urqnzekc20fj0er6de0q8qvhx34ahazsvs9p36`
//   ).data;

//   console.log({ recipientPrivateKey: bufToHex(recipientPrivateKey) });
...
//   console.log({ rumor, seal, wrap, unsealedRumor });
// };
